...
def get_argparser():
    ...
    argparser_obj = argparse.ArgumentParser(prog="make_pe_samplesheet")
    ...
    argparser_obj.add_argument("--wdl-input",
                               ...
                               dest="json_input",
                               required=True,
                               help="Base template for wdl input")
    ...
    argparser_obj.add_argument("--sample-sheet",
                               ...
                               dest="pheno_file",
                               required=True,
                               help="Path to Excel-formatted sample sheet containing info for each sample")

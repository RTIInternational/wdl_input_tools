...
WF_STATUS_VALS = [CROMWELL_SUCCESS_STATUS,
                  CROMWELL_FAILED_STATUS,
                  CROMWELL_RUNNING_STATUS,
                  CROMWELL_SUBMITTED_STATUS,
                  CROMWELL_ABORTED_STATUS,
                  CROMWELL_ABORTING_STATUS]
